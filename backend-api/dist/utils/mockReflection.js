...
exports.createMockReflection = void 0;
...
const includesAny = (thought, keywords) => keywords.some((keyword) => thought.includes(keyword));
const EGO_REACTIVE_TEMPLATE = {
    verdict: "AUTOPILOT",
    primaryPattern: "ego",
    intensity: 5,
    dopamineDrain: false,
    mirrorLine: "This thought carries a protective edge where proving yourself feels safer than pausing.",
    reframePrompt: "Take one slow breath and name the boundary you need without trying to win the moment.",
    emotionProfile: {
        ...
        explanation: "The force in your tone suggests pain is being defended through intensity."
    },
    journalEntry: {
...
const VENTING_TEMPLATE = {
    verdict: "AUTOPILOT",
    primaryPattern: "venting",
    intensity: 4,
    dopamineDrain: false,
    mirrorLine: "You sound emotionally flooded, and the body is asking to release pressure fast.",
    reframePrompt: "Pause for 90 seconds, then rewrite your response as one truth and one need.",
    emotionProfile: {
        primaryEmotion: "anger",
        secondaryEmotion: "hurt",
        ...
        explanation: "Venting often appears when pain is real but language is running ahead of regulation."
    },
    journalEntry: {
...
const DOOMSCROLL_TEMPLATE = {
    verdict: "AUTOPILOT",
    primaryPattern: "fear",
    intensity: 4,
    dopamineDrain: true,
    mirrorLine: "The scroll loop looks like overstimulation trying to numb a deeper unease.",
    reframePrompt: "Close the feed, put the phone down for two minutes, and let your breath slow first.",
    emotionProfile: {
        ...
        explanation: "Passive stimulation can mimic rest while actually draining attention and emotional clarity."
    },
    journalEntry: {
...
const FEAR_TEMPLATE = {
    ...
    intensity: 4,
    dopamineDrain: false,
    mirrorLine: "Your system is scanning for risk, which is making the moment feel bigger than it is.",
    reframePrompt: "Ground your body first, then choose one small next step you can control.",
    emotionProfile: {
        ...
        explanation: "Overwhelm often means your nervous system needs safety cues before problem-solving."
    },
    journalEntry: {
...
const HURT_TEMPLATE = {
    ...
    intensity: 3,
    dopamineDrain: false,
    mirrorLine: "There is sadness here beneath the words, asking for connection rather than performance.",
    reframePrompt: "Name what you miss directly, then choose one gentle reach-out or self-care step.",
    emotionProfile: {
        ...
        explanation: "Loneliness and rejection pain soften when they are acknowledged without self-judgment."
    },
    journalEntry: {
...
const APPROVAL_TEMPLATE = {
    ...
    intensity: 3,
    dopamineDrain: false,
    mirrorLine: "This sounds like a search for reassurance outside when worth feels unstable inside.",
    reframePrompt: "Offer yourself one validating sentence before checking anyone else's reaction.",
    emotionProfile: {
        ...
        explanation: "Approval-seeking rises when belonging feels conditional in the mind."
    },
    journalEntry: {
...
const GROUNDED_TEMPLATE = {
    ...
    intensity: 2,
    dopamineDrain: false,
    mirrorLine: "You sound regulated and intentional enough to choose a clean response.",
    reframePrompt: "Keep this steady tone and take one action aligned with your values.",
    emotionProfile: {
        primaryEmotion: "calm",
        ...
        explanation: "Your language shows emotional space between feeling and action, which supports wise decisions."
    },
    journalEntry: {
...
const INTENTIONAL_TEMPLATE = {
    verdict: "AUTHENTIC",
    primaryPattern: "intentional",
    intensity: 3,
    dopamineDrain: false,
    mirrorLine: "There is deliberate care in this thought, which suggests your values are leading.",
    reframePrompt: "Translate this intention into one specific, kind, and truthful next step.",
    emotionProfile: {
        ...
        bodyColor: "#2E9E8A",
        colorName: "deep jade",
        explanation: "Intentional language usually reflects healthy regulation and self-leadership."
    },
    journalEntry: {
...
const RELIEF_TEMPLATE = {
    verdict: "AUTHENTIC",
    primaryPattern: "grounded",
    intensity: 2,
    dopamineDrain: false,
    mirrorLine: "Relief is present, and your system is settling after sustained pressure.",
    reframePrompt: "Let this completion land for a moment, then choose one calm closure action.",
    emotionProfile: {
        ...
        bodyColor: "#4DB6AC",
        colorName: "cool teal",
        explanation: "Completion can restore regulation when you allow yourself to fully register progress."
    },
    journalEntry: {
...
const DEFAULT_NEUTRAL_TEMPLATE = {
    verdict: "AUTHENTIC",
    primaryPattern: "grounded",
    intensity: 2,
    dopamineDrain: false,
    mirrorLine: "You are in a workable state to pause, observe, and choose intentionally.",
    reframePrompt: "Take one breath, name your intention, and move with clarity.",
    emotionProfile: {
        ...
        explanation: "When signals are mixed, a grounded neutral stance helps prevent reactive decisions."
    },
    journalEntry: {
...
function createReflectionFromTemplate(template) {
    return {
...
const createMockReflection = (normalizedThought) => {
    ...
    if (includesAny(normalizedThought, ANGRY_KEYWORDS)) {
        const egoIntent = normalizedThought.includes("prove") ||
    ...
    if (includesAny(normalizedThought, GROUNDED_KEYWORDS)) {
        const intentionalIntent = normalizedThought.includes("intentional") ||
...
exports.createMockReflection = createMockReflection;
